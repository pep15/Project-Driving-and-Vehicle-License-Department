...
namespace DVLD.ControlApplicationsTest.ScheduleTestStreet
{
    public partial class ctrlstreetTest : UserControl
    {
        ...
        public ctrlstreetTest(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
        ...
        private void _RefrechContactList(bool RefreshDataFromDB = true)
        {
            ...
            {
                dtAppointmentsTest = clsAppointments.GetAllAppointment(3);
        ...
        public void Load_ctrlstreetTestAppointments(int LocalDrivingLicenseApplicationID)
        {
        ...
        private void btnAddLocalApplications_Click_1(object sender, EventArgs e)
        {
            int ApplicationID = -1;
            bool shouldOpenRetakeScreen = false;
            if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
            {
                if (clsAppointments.HasActiveAppointment(_VisionTestAppointments.LocalDrivingLicenseApplicationID, 3, false))
                {
                ...
                {
                    clsVisionTest lastTestResult = clsVisionTest.GetLastTestAppointmentResult(_LocalDrivingLicenseApplicationID, 3, true);
            ...
            if (shouldOpenRetakeScreen)
            {
                if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
                {
                    Form scheduleRetakeTest = new frmScheduleRetakeTestStreet(_LocalDrivingLicenseApplicationID);
            ...
            else
            {
                ...
                if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
                {
                    ...
                    Form FrmscheduleTestWriiten = new FrmScheduleTestStreet(FrmScheduleTestStreet.enMode.Add, _LocalDrivingLicenseApplicationID, ApplicationID);
                    FrmscheduleTestWriiten.ShowDialog();
                    _RefrechContactList(true);
                }
                else
                {
        ...
        private void editToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            _ScheduleRetakeTest = clsScheduleRetakeTest.ScheduleRetakeFind(ApplicationID, 3);
            if (_ScheduleRetakeTest != null)
            {
                if (_ScheduleRetakeTest.ApplicationTypeID == 8)
                {
                    if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
                    {
                        Form FrmscheduleTestWritten = new FrmScheduleTestStreet(FrmScheduleTestStreet.enMode.RetakeExam, _LocalDrivingLicenseApplicationID, ApplicationID);
                        FrmscheduleTestWritten.ShowDialog();
                        _RefrechContactList(true);
                    }
                ...
                else
                {
                    if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
                    {
                        Form FrmscheduleTestWrittenUpdate = new FrmScheduleTestStreet(FrmScheduleTestStreet.enMode.Update, _LocalDrivingLicenseApplicationID, ApplicationID);
                        FrmscheduleTestWrittenUpdate.ShowDialog();
                        _RefrechContactList(true);
                    }
                }
            }
        ...
        private void takeTestToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
            {
                Form TakeTest = new frmPassFaillTestStreet(_LocalDrivingLicenseApplicationID);
                TakeTest.ShowDialog();
            }
            _RefrechContactList(true);
        }
