...
{
    public partial class ctrlScheduleTestStreet : UserControl
    {
        ...
        public ctrlScheduleTestStreet()
        {
            InitializeComponent();
        }
        public ctrlScheduleTestStreet(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
            InitializeComponent();
        ...
        public void UpdateAppointment()
        {
            ...
            {
                _AddAppointments = clsAppointments.FindAppointments(_ApplicationID, 3);
        ...
        public void AddNewSchedultStreet(int LocalDrivingLicenseApplicationID)
        {
            if (_Mode == eMode.Add)
            {
