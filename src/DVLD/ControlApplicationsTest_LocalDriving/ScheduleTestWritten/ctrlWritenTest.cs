...
{
    public partial class ctrlWritenTest : UserControl
    {
        ...
        public ctrlWritenTest()
        {
            InitializeComponent();
        }
        public ctrlWritenTest(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
        ...
        private void _RefrechContactList(bool RefreshDataFromDB = true)
        {
            ...
            {
                dtAppointmentsTest = clsAppointments.GetAllAppointment(2);
        ...
        public void Load_ctrlWriteTestAppointments(int LocalDrivingLicenseApplicationID)
        {
        ...
        private void btnAddLocalApplications_Click(object sender, EventArgs e)
        {
            ...
            if(shouldOpenRetakeScreen)
            {
                if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
                {
                    Form scheduleRetakeTest = new frmScheduleRetakeTestWritten(_LocalDrivingLicenseApplicationID);
            ...
            else
            {
                    ...
                    if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
                    {
                        ...
                        Form FrmscheduleTestWriiten= new FrmScheduleTestWritten(FrmScheduleTestWritten.enMode.Add, _LocalDrivingLicenseApplicationID, ApplicationID);
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            _ScheduleRetakeTest = clsScheduleRetakeTest.ScheduleRetakeFind(ApplicationID, 2);
            if (_ScheduleRetakeTest != null)
            {
                if(_ScheduleRetakeTest.ApplicationTypeID == 8)
                {
                    if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
                    {
                        Form FrmscheduleTestWritten = new FrmScheduleTestWritten(FrmScheduleTestWritten.enMode.RetakeExam, _LocalDrivingLicenseApplicationID, ApplicationID);
                ...
                else
                {
                    if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
                    {
                        Form FrmscheduleTestWrittenUpdate = new FrmScheduleTestWritten(FrmScheduleTestWritten.enMode.Update, _LocalDrivingLicenseApplicationID, ApplicationID);
        ...
        private void takeTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(LbDLAppID.Text, out _LocalDrivingLicenseApplicationID))
            {
                Form TakeTest = new frmPassFaillTestWritten(_LocalDrivingLicenseApplicationID);
                TakeTest.ShowDialog();
            }
            _RefrechContactList(true);
        }
