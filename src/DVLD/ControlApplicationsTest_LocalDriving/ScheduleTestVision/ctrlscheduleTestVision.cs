...
{
    public partial class ctrlscheduleTestVision : UserControl
    {
       ...
       private int _LocalDrivingLicenseApplicationID = -1;
        ...
        public ctrlscheduleTestVision()
        {
            InitializeComponent();
        }
        public ctrlscheduleTestVision(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
        ...
        public void UpdateAppointment()
        {
            ...
            {
                _AddAppointments = clsAppointments.FindAppointments(_ApplicationID, 1);
