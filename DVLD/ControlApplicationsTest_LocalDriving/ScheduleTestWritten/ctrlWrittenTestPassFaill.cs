...
{
    public partial class ctrlWrittenTestPassFaill : UserControl
    {
        ...
        public ctrlWrittenTestPassFaill()
        {
            InitializeComponent();
        }
        public ctrlWrittenTestPassFaill(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
